...
object GlobalUtil {
    ...
    val appPackage: String
        get() = SpaceXApplication.context.packageName
     ...
     */
    val appName: String
        get() = if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.DONUT) {
            SpaceXApplication.context.resources.getString(SpaceXApplication.context.applicationInfo.labelRes)
        } else {
    ...
    val appVersionName: String
        get() = SpaceXApplication.context.packageManager.getPackageInfo(appPackage, 0).versionName
    ...
    val appVersionCode: Long
        get() = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            SpaceXApplication.context.packageManager.getPackageInfo(appPackage, 0).longVersionCode
        } else {
            SpaceXApplication.context.packageManager.getPackageInfo(appPackage, 0).versionCode.toLong()
        }
    ...
    fun getString(resId: Int): String {
        return SpaceXApplication.context.resources.getString(resId)
    }
    ...
    fun getDimension(resId: Int): Int {
        return SpaceXApplication.context.resources.getDimensionPixelOffset(resId)
    }
    ...
    fun getResourceId(name: String, type: String): Int {
        return SpaceXApplication.context.resources.getIdentifier(name, type, appPackage)
    }
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            applicationInfo = SpaceXApplication.context.packageManager.getApplicationInfo(appPackage, PackageManager.GET_META_DATA)
    ...
    fun isInstalled(packageName: String): Boolean {
        val packageInfo: PackageInfo? = try {
            SpaceXApplication.context.packageManager.getPackageInfo(packageName, 0)
        } catch (e: PackageManager.NameNotFoundException) {
            null
        }
    ...
    fun getAppIcon(): Drawable {
        val packageManager = SpaceXApplication.context.packageManager
